...
handled through [GitHub](https://github.com//fastcsflame/issues). Also, please check for any existing issues before
...
Github also offers [discussions](https://github.com//fastcsflame/discussions) as a place to ask questions and share ideas. If
